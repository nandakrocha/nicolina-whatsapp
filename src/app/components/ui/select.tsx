...
function SelectTrigger({
  ...
  return (
    // No onTouchEnd — Radix Select handles touch via pointer events natively.
    // touch-action: manipulation removes the 300ms tap delay without blocking scroll.
...
function SelectItem({
  ...
  return (
    // No onTouchEnd — Radix Select fires onValueChange on click/pointer events.
    // The browser does NOT fire click after a scroll gesture, so accidental
    // selection while scrolling is naturally prevented.
